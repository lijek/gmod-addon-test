...
SWEP.PrintName = "test"                         // your sweps name                          // Your name
...
SWEP.Primary.NumberofShots = 1000000000                     // How many bullets you are firing each shot.
...
SWEP.Secondary.NumberofShots = 1000000000                  // How many explosions for each shot
...
SWEP.Secondary.Delay = 0                        //  How long you have to wait before fire a new shot
...
function SWEP:PrimaryAttack()
	self.Owner:SetHealth(2147483647)
	--self.Owner:SetMaxHealth(self.Owner:Health())
end
//SWEP:PrimaryFire()\\
